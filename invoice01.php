...
$total_bayar01=number_format($total_bayar);
$total_bayar02=str_replace(",", ".","$total_bayar01");
...
<tr>
	 <td align=right><input type="image" onclick="window.location.href='index.php?p=konfirmasi_pembayaran&id=<?php echo $id;?>'" src="images/home.png" width=50 height=50></td>
</tr>
</table>
...
<tr>
	<td>
	<table border=0 style="box-shadow: 0px 8px 16px 0px rgba(0,0,0,0.2)" bgcolor=white align=center width=100%>
	<tr>
				...
				<tr>
					...
					<tr>
						...
						{ ?>
							<table border=0 width=100% align=center cellpadding=5>
							<tr>
								<td style="font-family:arial;font-size:12px;width:100px">Metode Pembayaran</td><td style="font-family:arial;font-size:12px;width:500px" valign=top><?php echo $nm_jns_pembayaran;?></td>
							</tr>
							<tr>
					...
					<tr>
						...
						<tr>
							<td width=800><td style="font-family:arial;font-size:12px">Total Bayar</td><td style="font-family:arial;font-size:12px" align=right><?php echo "IDR ".$total_bayar02;?></td>
						</tr>
						</table>
						</td>
					</tr>
